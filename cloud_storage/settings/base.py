...
SECRET_KEY = 's56)k05f)pz21py(t-@0k6sin^pci75e-_q$k!dzj4nl(ug2v5'
...
GS_CREDENTIALS = service_account.Credentials.from_service_account_file(
    os.path.join(BASE_DIR, 'storage-credential.json'))

DEFAULT_FILE_STORAGE = 'cloud_storage.gcloud.GoogleCloudMediaFileStorage'
